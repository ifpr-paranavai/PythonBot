...
class ExampleConversation extends Conversation
{
    ...
    {
        $question = Question::create("Olá, como posso ajudar?")
            ->fallback('Unable to ask question')
            ->callbackId('ask_reason')
            ->addButtons([
                Button::create('Me fale uma curiosidade sobre Alan Turing')->value('turing'),
                Button::create('Me fale uma curiosidade sobre o IFPR Campús Paranavaí')->value('quote'),
            ]);
